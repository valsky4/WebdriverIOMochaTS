...
export class AppiumDriver extends DriverCore<typeof import("@appium/types").BASE_DESIRED_CAP_CONSTRAINTS> implements SessionHandler {
    ...
    driverForSession(sessionId: any): import("@appium/types").ExternalDriver<Readonly<Record<string, import("@appium/types").Constraint>>>;
    getStatus(): Promise<{
        build: import("../types").BuildInfo;
    }>;
    getSessions(): Promise<{
        id: string;
        capabilities: Partial<import("@appium/types").ConstraintsToCaps<Readonly<Record<string, import("@appium/types").Constraint>>> & void> | undefined;
    }[]>;
